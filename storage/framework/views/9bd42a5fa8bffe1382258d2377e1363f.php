<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($show): ?>
        <div class="fixed inset-0 z-50 flex items-end justify-center sm:items-center p-4"
             x-data="{ show: <?php if ((object) ('show') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('show'->value()); ?>')<?php echo e('show'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('show'); ?>')<?php endif; ?> }"
             x-show="show"
            ...
            <div class="relative w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-2xl"
                ...
                <div class="h-1.5 w-full
                    <?php if($type === 'success'): ?> bg-gradient-to-r from-emerald-400 to-green-500
                    <?php elseif($type === 'error'): ?> bg-gradient-to-r from-red-400 to-rose-500
                    <?php elseif($type === 'warning'): ?> bg-gradient-to-r from-amber-400 to-orange-500
                    <?php else: ?> bg-gradient-to-r from-blue-400 to-indigo-500
                    <?php endif; ?>">
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-base font-bold text-slate-800"><?php echo e($title); ?></h3>
                                <p class="mt-0.5 text-xs text-slate-400">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'success'): ?> Action completed
                                    <?php elseif($type === 'error'): ?> Something went wrong
                                    <?php elseif($type === 'warning'): ?> Attention required
                    ...
                    <p class="text-sm leading-relaxed text-slate-600"><?php echo e($message); ?></p>
                    ...
                    <div class="mt-5 flex justify-end gap-2">
                        ...
                        <button wire:click="close"
                            ...
                            <?php if($type === 'success'): ?> bg-gradient-to-br from-emerald-400 to-green-500 hover:from-emerald-500 hover:to-green-600
                            <?php elseif($type === 'error'): ?> bg-gradient-to-br from-red-400 to-rose-500 hover:from-red-500 hover:to-rose-600
                            <?php elseif($type === 'warning'): ?> bg-gradient-to-br from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600
                            <?php else: ?> bg-gradient-to-br from-blue-400 to-indigo-500 hover:from-blue-500 hover:to-indigo-600
                            <?php endif; ?>">
                            Got it
                        </button>
                    </div>
...
<?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/livewire/global-modal.blade.php ENDPATH**/ ?>