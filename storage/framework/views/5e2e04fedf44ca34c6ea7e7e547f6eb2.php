<div class="mx-auto max-w-5xl space-y-8 pb-12">
            ...
            <div class="flex items-center justify-between rounded-xl bg-blue-50/50 p-4 ring-1 ring-blue-100">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-xl font-black text-slate-900"><?php echo e(number_format($studentCount)); ?> Students</div>
                    </div>
                </div>
                <div class="text-right">
                    <div class="text-sm font-semibold text-slate-600">Yearly Base Cost</div>
                    <div class="text-2xl font-black text-slate-900">₦<?php echo e(number_format($this->coreCost)); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="mt-6 grid gap-6 md:grid-cols-3">
            <!-- WhatsApp Bot -->
            <div class="relative flex flex-col justify-between overflow-hidden rounded-2xl bg-white p-6 shadow-sm ring-1 transition-all <?php echo e($whatsapp ? 'ring-2 ring-green-500' : 'ring-slate-200'); ?>">
                <div>
                ...
                <a href="<?php echo e(route('marketplace.product', 'whatsapp-bot')); ?>" class="mt-6 block text-center w-full rounded-xl py-2.5 text-sm font-bold transition-all bg-slate-900 text-white hover:bg-slate-800">
                    View in Marketplace
                </a>
            </div>

            <!-- CBT Pro -->
            <div class="relative flex flex-col justify-between overflow-hidden rounded-2xl bg-white p-6 shadow-sm ring-1 transition-all <?php echo e($cbt ? 'ring-2 ring-violet-500' : 'ring-slate-200'); ?>">
                <div>
                ...
                <a href="<?php echo e(route('marketplace.product', 'cbt')); ?>" class="mt-6 block text-center w-full rounded-xl py-2.5 text-sm font-bold transition-all bg-slate-900 text-white hover:bg-slate-800">
                    View in Marketplace
                </a>
            </div>

            <!-- Parent App+ -->
            <div class="relative flex flex-col justify-between overflow-hidden rounded-2xl bg-white p-6 shadow-sm ring-1 transition-all <?php echo e($parent_app ? 'ring-2 ring-pink-500' : 'ring-slate-200'); ?>">
                <div>
                ...
                <a href="<?php echo e(route('marketplace.product', 'student-dashboard')); ?>" class="mt-6 block text-center w-full rounded-xl py-2.5 text-sm font-bold transition-all bg-slate-900 text-white hover:bg-slate-800">
                    View in Marketplace
                </a>
            </div>
        </div>
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 lg:col-span-2">
            ...
            <div class="mt-6 flex flex-col gap-4">
                <div class="flex items-center justify-between rounded-xl <?php echo e($whatsapp ? 'bg-green-50 ring-green-200' : 'bg-slate-50 ring-slate-200'); ?> p-4 ring-1">
                    <div class="flex items-center gap-3">
                        <div class="rounded-lg <?php echo e($whatsapp ? 'bg-green-500' : 'bg-slate-400'); ?> p-2 text-white shadow-sm">
                        ...
                        <div>
                            <div class="font-bold <?php echo e($whatsapp ? 'text-green-900' : 'text-slate-900'); ?>">WhatsApp Broadcasts</div>
                            <div class="text-xs <?php echo e($whatsapp ? 'text-green-700' : 'text-slate-600'); ?>">Unlimited bulk messaging to parents and staff</div>
                        </div>
                    </div>
                    <div class="text-right">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('marketplace.product', 'whatsapp-bot')); ?>" class="mt-1 inline-block text-sm font-semibold text-slate-600 hover:text-slate-900">View in Marketplace</a>
        ...
        <div class="rounded-2xl bg-slate-900 p-6 text-white shadow-xl">
            ...
            <p class="mt-1 text-sm text-slate-400">Next billing cycle: <?php echo e(now()->addYear()->format('M Y')); ?></p>
            
            <div class="mt-6 flex flex-col gap-3 border-y border-slate-700 py-4 text-sm font-medium text-slate-300">
                <div class="flex justify-between">
                    <span>Base (<?php echo e(number_format($studentCount)); ?> students)</span>
                    <span>₦<?php echo e(number_format($this->coreCost)); ?></span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($whatsapp): ?>
                <div class="flex justify-between text-green-400">
                    <span>WA Bot Pro</span>
                    <span>₦<?php echo e(number_format($studentCount * 300)); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cbt): ?>
                <div class="flex justify-between text-violet-400">
                    <span>CBT Pro</span>
                    <span>₦<?php echo e(number_format($studentCount * 200)); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($parent_app): ?>
                <div class="flex justify-between text-pink-400">
                    <span>Parent App+</span>
                    <span>₦<?php echo e(number_format($studentCount * 150)); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="mt-6">
                <div class="flex items-end justify-between">
                    ...
                    <span class="text-3xl font-black">₦<?php echo e(number_format($this->totalCost)); ?></span>
                </div>
...
<script>
    Livewire.on('initialize-paystack', (eventData) => {
        ...
        let handler = PaystackPop.setup({
            key: '<?php echo e(env('PAYSTACK_PUBLIC_KEY', 'pk_test_')); ?>', // Handled by standard env
            email: data.email,
    ...
    ?>
<?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/livewire/admin/subscription-billing.blade.php ENDPATH**/ ?>