        ...
        <aside id="desktopSidebar"
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" wire:navigate
                    class="<?php echo e(request()->routeIs('dashboard') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user?->role !== 'parent'): ?>
                    <a href="<?php echo e(route('students.index')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('students.*') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user?->role === 'admin'): ?>
                    <a href="<?php echo e(route('teachers')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('teachers') || request()->routeIs('teachers.*') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                    ...
                    <a href="<?php echo e(route('parents.index')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('parents.*') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user?->role === 'admin' || $user?->role === 'teacher'): ?>
                    <a href="<?php echo e(route('classes.index')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('classes.*') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                    ...
                    <a href="<?php echo e(route('subjects.index')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('subjects.*') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                    ...
                    <a href="<?php echo e(route('results.entry')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('results.entry') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user?->role === 'admin'): ?>
                    <a href="<?php echo e(route('results.broadsheet')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('results.broadsheet') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <a href="<?php echo e(route('attendance')); ?>" wire:navigate
                    class="<?php echo e(request()->routeIs('attendance') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <a href="<?php echo e(route('homework.index')); ?>" wire:navigate
                    class="<?php echo e(request()->routeIs('homework.*') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <a href="<?php echo e(route('messages')); ?>" wire:navigate
                    class="<?php echo e(request()->routeIs('messages') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
...
?>
                ...
                <a href="<?php echo e($cbtHref); ?>" wire:navigate
                    class="<?php echo e($cbtIsActive ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> <?php echo e($cbtLocked ? 'opacity-60' : ''); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($user?->role, ['admin', 'teacher', 'bursar'], true)): ?>
                    <a href="<?php echo e(route('more-features')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('more-features') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user?->role === 'admin'): ?>
                    <a href="<?php echo e(route('settings.index')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('settings.*') && !request()->routeIs('settings.subscription') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
                    ...
                    <a href="<?php echo e(route('settings.subscription')); ?>" wire:navigate
                        class="<?php echo e(request()->routeIs('settings.subscription') ? 'bg-amber-50 text-amber-700 border-l-2 border-amber-500' : 'text-slate-700 hover:bg-amber-50'); ?> mb-0.5 group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold transition-all">
