<div class="fixed inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo e(asset('images/cbt.png')); ?>');">
    <div class="flex h-screen w-screen items-center justify-center p-6 bg-black/20">
        <div class="w-full max-w-sm rounded-2xl bg-white/80 backdrop-blur-xl p-6 shadow-2xl">
            <div class="mb-4 text-center">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($examCode): ?>
            ...
            <form wire:submit="start" class="space-y-3" x-data="{ showPin: false }">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($examCode): ?>
                    <div class="rounded-xl bg-blue-50 px-4 py-2.5 text-center border-2 border-blue-200">
                        ...
                        <div class="mt-0.5 font-mono text-sm font-black text-blue-900"><?php echo e($examCode); ?></div>
                    </div>
                <?php else: ?>
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['examCode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="mt-1.5 text-xs font-semibold text-rose-700"><?php echo e($message); ?></div> <?php unset($message);
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-xs font-semibold text-rose-700"><?php echo e($message); ?></div> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/livewire/cbt/portal/start.blade.php ENDPATH**/ ?>