...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Custom Fields','subtitle' => 'Manage additional fields for student, teacher & parent registration.','accent' => 'settings']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Custom Fields','subtitle' => 'Manage additional fields for student, teacher & parent registration.','accent' => 'settings']); ?>
...
<?php endif; ?>
    ...
    <div class="flex items-center gap-1 rounded-xl border border-gray-100 bg-white p-1.5 shadow-sm w-fit">
        <button wire:click="$set('filterFormType', 'all')"
                class="rounded-lg px-4 py-2 text-sm font-medium transition-all <?php echo e($filterFormType === 'all' ? 'bg-blue-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
            All Fields
        </button>
        <button wire:click="$set('filterFormType', 'student')"
                class="rounded-lg px-4 py-2 text-sm font-medium transition-all <?php echo e($filterFormType === 'student' ? 'bg-blue-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
        ...
        <button wire:click="$set('filterFormType', 'teacher')"
                class="rounded-lg px-4 py-2 text-sm font-medium transition-all <?php echo e($filterFormType === 'teacher' ? 'bg-blue-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
        ...
        <button wire:click="$set('filterFormType', 'parent')"
                class="rounded-lg px-4 py-2 text-sm font-medium transition-all <?php echo e($filterFormType === 'parent' ? 'bg-blue-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($fields) > 0): ?>
            <div class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between p-6" wire:key="field-<?php echo e($field['id']); ?>">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="flex items-center gap-2">
                                    <h4 class="font-medium text-gray-900"><?php echo e($field['label']); ?></h4>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($field['form_type'] ?? 'student') === 'student'): ?>
                                    ...
                                    <?php elseif(($field['form_type'] ?? '') === 'parent'): ?>
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$field['is_active']): ?>
                                        <span class="inline-flex items-center rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-800">Inactive</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <p class="text-sm text-gray-600"><?php echo e(ucfirst($field['type'])); ?> field (<?php echo e($field['name']); ?>)</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            <button wire:click="toggleActive(<?php echo e($field['id']); ?>)" 
                                    class="text-sm <?php echo e($field['is_active'] ? 'text-orange-600 hover:text-orange-700' : 'text-green-600 hover:text-green-700'); ?>">
                                <?php echo e($field['is_active'] ? 'Deactivate' : 'Activate'); ?>

                            </button>
                            <button wire:click="editField(<?php echo e($field['id']); ?>)" class="text-sm text-blue-600 hover:text-blue-700">
                                Edit
                            </button>
                            <button wire:click="deleteField(<?php echo e($field['id']); ?>)" 
            ...
            <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-900">
                        <?php echo e($editingField ? 'Edit Field' : 'Add Field'); ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <label class="relative flex cursor-pointer items-center rounded-xl border-2 p-3 transition-all
                                <?php echo e($formType === 'student' ? 'border-blue-500 bg-blue-50 ring-1 ring-blue-500' : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'); ?>">
                                <input type="radio" wire:model.live="formType" value="student" class="sr-only">
                                <div class="flex items-center gap-2.5">
                                    <div class="flex h-8 w-8 items-center justify-center rounded-lg <?php echo e($formType === 'student' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-500'); ?>">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/></svg>
                                    </div>
                                    <div>
                                        <div class="text-sm font-semibold <?php echo e($formType === 'student' ? 'text-blue-900' : 'text-gray-900'); ?>">Student</div>
                                        <div class="text-xs <?php echo e($formType === 'student' ? 'text-blue-600' : 'text-gray-500'); ?>">Registration form</div>
                                    </div>
                                </div>
                            </label>
                            <label class="relative flex cursor-pointer items-center rounded-xl border-2 p-3 transition-all
                                <?php echo e($formType === 'teacher' ? 'border-purple-500 bg-purple-50 ring-1 ring-purple-500' : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'); ?>">
                                <input type="radio" wire:model.live="formType" value="teacher" class="sr-only">
                                <div class="flex items-center gap-2.5">
                                    <div class="flex h-8 w-8 items-center justify-center rounded-lg <?php echo e($formType === 'teacher' ? 'bg-purple-500 text-white' : 'bg-gray-100 text-gray-500'); ?>">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                                    </div>
                                    <div>
                                        <div class="text-sm font-semibold <?php echo e($formType === 'teacher' ? 'text-purple-900' : 'text-gray-900'); ?>">Teacher</div>
                                        <div class="text-xs <?php echo e($formType === 'teacher' ? 'text-purple-600' : 'text-gray-500'); ?>">Staff form</div>
                                    </div>
                                </div>
                            </label>
                            <label class="relative flex cursor-pointer items-center rounded-xl border-2 p-3 transition-all
                                <?php echo e($formType === 'parent' ? 'border-green-500 bg-green-50 ring-1 ring-green-500' : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'); ?>">
                                <input type="radio" wire:model.live="formType" value="parent" class="sr-only">
                                <div class="flex items-center gap-2.5">
                                    <div class="flex h-8 w-8 items-center justify-center rounded-lg <?php echo e($formType === 'parent' ? 'bg-green-500 text-white' : 'bg-gray-100 text-gray-500'); ?>">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                    </div>
                                    <div>
                                        <div class="text-sm font-semibold <?php echo e($formType === 'parent' ? 'text-green-900' : 'text-gray-900'); ?>">Parent</div>
                                        <div class="text-xs <?php echo e($formType === 'parent' ? 'text-green-600' : 'text-gray-500'); ?>">Parent form</div>
                                    </div>
                                </div>
                            </label>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['formType'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input wire:model="placeholder" type="text" placeholder="Enter placeholder text" 
                               class="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['placeholder'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-red-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex gap-3 pt-4">
                        <button type="submit" 
                            ...
                            <span wire:loading.remove wire:target="saveField">
                                <?php echo e($editingField ? 'Update Field' : 'Create Field'); ?>

                            </span>
                            <span wire:loading wire:target="saveField">
                                <?php echo e($editingField ? 'Updating...' : 'Creating...'); ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/livewire/settings/custom-fields.blade.php ENDPATH**/ ?>