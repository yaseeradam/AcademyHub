...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Submissions: '.e($homework->title).'','subtitle' => ''.e($homework->class->name).' - '.e($homework->subject->name).' (Due: '.e($homework->due_date->format('M j, Y')).')','accent' => 'teachers']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Submissions: '.e($homework->title).'','subtitle' => ''.e($homework->class->name).' - '.e($homework->subject->name).' (Due: '.e($homework->due_date->format('M j, Y')).')','accent' => 'teachers']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('homework.index')); ?>" class="btn-outline">
    ...
    <div class="card-padded">
        <div class="mb-6 flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-900">
                Submissions (<?php echo e($submissions->count()); ?>)
            </h3>
        </div>
...
<?php $component->withAttributes([]); ?>
            ...
            <tbody class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="bg-white hover:bg-gray-50">
                        <td class="px-5 py-4">
                            <div class="text-sm font-semibold text-gray-900">
                                <?php echo e($submission->student->full_name); ?>

                            </div>
                            <div class="text-xs text-gray-500">
                                <?php echo e($submission->student->admission_number); ?>

                            </div>
                        </td>
                        <td class="px-5 py-4 text-sm text-gray-700">
                            <?php echo e($submission->submitted_at->format('M j, Y g:i A')); ?>

                        </td>
                        <td class="px-5 py-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->grade !== null): ?>
                                <span class="text-sm font-semibold text-gray-900"><?php echo e($submission->grade); ?>%</span>
                            <?php else: ?>
                                <span class="text-sm text-gray-400">Not graded</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-5 py-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->graded_at): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'success']); ?>Graded <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <td class="px-5 py-4 text-right">
                            <button wire:click="gradeSubmission(<?php echo e($submission->id); ?>)" class="text-sm font-semibold text-blue-600 hover:text-blue-700">
                                <?php echo e($submission->graded_at ? 'Edit Grade' : 'Grade'); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showGradeModal): ?>
                ...
                <div class="relative bg-white rounded-2xl shadow-xl max-w-lg w-full p-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission): ?>
                        <div class="mb-4 p-4 bg-gray-50 rounded-xl">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->attachment): ?>
                                <a href="<?php echo e(Storage::url($submission->attachment)); ?>" target="_blank" class="mt-2 inline-flex items-center text-sm text-blue-600 hover:text-blue-700">
...
<?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/livewire/homework/submissions.blade.php ENDPATH**/ ?>