    ...
    <div class="relative overflow-hidden rounded-2xl shadow-xl" style="background: linear-gradient(135deg, #166534 0%, #15803d 60%, #16a34a 100%);">
        ...
        <div class="relative flex items-end justify-between">
            ...
            <div class="flex-1 px-8 py-8">
                ...
                <h2 class="text-4xl font-bold text-white tracking-tight">Welcome, <?php echo e($student->first_name); ?>!</h2>
                <p class="mt-2 text-lg font-medium" style="color:#6ee7b7;">
                    <?php echo e($student->schoolClass?->name ?? 'N/A'); ?><?php echo e($student->section ? ' · ' . $student->section->name : ''); ?>
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    ...
                    <span class="inline-flex items-center gap-2 rounded-lg px-4 py-1.5 text-sm font-semibold text-white" style="background:rgba(255,255,255,0.15);">
                        ...
                        <?php echo e(config('myacademy.current_session')); ?> — Term <?php echo e(config('myacademy.current_term')); ?>
                ...
                <?php else: ?>
                    <div class="h-40 w-32 flex items-center justify-center" style="background:rgba(255,255,255,0.1);">
                        <div class="h-16 w-16 rounded-full flex items-center justify-center text-white text-3xl font-black"
                            ...
                            <?php echo e(mb_strtoupper(mb_substr($student->first_name, 0, 1))); ?>
    ...
    <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-400 to-green-500 p-6 text-white shadow-lg">
            ...
            <div class="relative flex items-start justify-between">
                <div>
                    <div class="text-4xl font-black"><?php echo e($stats['attendance_rate']); ?>%</div>
                    <div class="mt-1 text-sm font-semibold text-white/80">Attendance</div>
                    <div class="mt-0.5 text-xs text-white/60"><?php echo e($stats['present_days']); ?>/<?php echo e($stats['total_days']); ?> days</div>
                </div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 p-6 text-white shadow-lg">
            ...
            <div class="relative flex items-start justify-between">
                <div>
                    <div class="text-4xl font-black"><?php echo e($stats['average_score']); ?>%</div>
                    <div class="mt-1 text-sm font-semibold text-white/80">Average Score</div>
                    <div class="mt-0.5 text-xs text-white/60"><?php echo e($stats['total_subjects']); ?> subjects</div>
                </div>
                <div class="grid h-12 w-12 place-items-center rounded-xl bg-white/20">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 p-6 text-white shadow-lg">
            ...
            <div class="relative flex items-start justify-between">
                <div>
                    <div class="text-4xl font-black"><?php echo e($stats['position'] ? '#'.$stats['position'] : 'N/A'); ?></div>
                    <div class="mt-1 text-sm font-semibold text-white/80">Class Position</div>
                    <div class="mt-0.5 text-xs text-white/60">of <?php echo e($stats['total_students']); ?> students</div>
                </div>
                <div class="grid h-12 w-12 place-items-center rounded-xl bg-white/20">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br <?php echo e($stats['overdue_homework'] > 0 ? 'from-red-500 to-rose-600' : 'from-violet-500 to-purple-600'); ?> p-6 text-white shadow-lg">
            <div class="absolute -right-6 -top-6 h-28 w-28 rounded-full bg-white/10"></div>
            <div class="absolute right-4 bottom-4 h-16 w-16 rounded-full bg-white/10"></div>
            <div class="relative flex items-start justify-between">
                <div>
                    <div class="text-4xl font-black"><?php echo e($stats['pending_homework']); ?></div>
                    <div class="mt-1 text-sm font-semibold text-white/80">Pending HW</div>
                    <div class="mt-0.5 text-xs text-white/60">
                        <?php echo e($stats['overdue_homework'] > 0 ? $stats['overdue_homework'].' overdue' : 'All up to date'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route($action['route'])); ?>"
                       class="group flex items-center gap-3 rounded-xl px-3 py-3 transition hover:bg-slate-50">
                        <div class="grid h-10 w-10 flex-shrink-0 place-items-center rounded-xl bg-gradient-to-br <?php echo e($action['from']); ?> <?php echo e($action['to']); ?> text-white shadow-sm transition group-hover:scale-105">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><?php echo $action['icon']; ?></svg>
                        </div>
                        <div class="min-w-0 flex-1">
                            <div class="text-sm font-bold text-slate-800"><?php echo e($action['label']); ?></div>
                            <div class="text-xs text-slate-400"><?php echo e($action['sub']); ?></div>
                        </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($stats['grades']) > 0): ?>
                    <div class="grid grid-cols-6 gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['A', 'B', 'C', 'D', 'E', 'F']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="flex flex-col items-center justify-center rounded-xl border-2 py-5 <?php echo e($cls); ?>">
                                <div class="text-2xl font-black"><?php echo e($grade); ?></div>
                                <div class="mt-1 text-xs font-semibold"><?php echo e($count); ?> subj</div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="mt-5 space-y-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['A' => ['Excellent','bg-emerald-500'], 'B' => ['Very Good','bg-blue-500'], 'C' => ['Good','bg-amber-500'], 'F' => ['Fail','bg-red-500']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g => [$label, $bar]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $cnt = $stats['grades'][$g] ?? 0; $pct = $stats['total_subjects'] > 0 ? round(($cnt / $stats['total_subjects']) * 100) : 0; ?>
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-6 text-xs font-bold text-slate-500"><?php echo e($g); ?></div>
                                <div class="flex-1 h-2 rounded-full bg-slate-100 overflow-hidden">
                                    <div class="h-full rounded-full <?php echo e($bar); ?>" style="width: <?php echo e($pct); ?>%"></div>
                                </div>
                                <div class="w-8 text-right text-xs font-semibold text-slate-500"><?php echo e($pct); ?>%</div>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
