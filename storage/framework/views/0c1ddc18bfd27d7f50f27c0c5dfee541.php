...
?>
    ...
    <div class="page" style="position: relative;">
        ...
        <div style="text-align: center; font-size: 7px; color: #059669; font-weight: 700; margin-bottom: 8px;">
            Session <?php echo e($session); ?> • Term <?php echo e($term); ?> • <?php echo e(now()->format('F d, Y')); ?>
            ...
            <div class="info-card">
                <div class="info-inner">
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo e($student->gender ?? 'N/A'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Age</div>
                        <div class="info-value"><?php echo e($student->dob ? \Carbon\Carbon::parse($student->dob)->age . ' years' : 'N/A'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Class Size</div>
                        <div class="info-value"><?php echo e($totalStudents ?? 'N/A'); ?> Students</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="next-fresh">🌿 Next Term Begins: <?php echo e($nextTermDate ?? 'To be announced'); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="footer"><?php echo e($schoolName); ?> • Growing Excellence Together</div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/pdf/report-card-fresh.blade.php ENDPATH**/ ?>