    ...
    >
        ...
        <div class="flex items-center justify-between border-b border-slate-100 px-4 py-3 bg-gradient-to-r from-indigo-50 to-purple-50">
            <div class="flex items-center gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->unreadCount > 0): ?>
                    <span class="rounded-full bg-indigo-600 px-2 py-0.5 text-[10px] font-black text-white"><?php echo e($this->unreadCount); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="flex items-center gap-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->unreadCount > 0): ?>
        ...
        <div class="max-h-[420px] overflow-y-auto divide-y divide-slate-50">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-start gap-3 px-4 py-3 <?php echo e(!$n->read_at ? 'bg-indigo-50/40' : 'hover:bg-slate-50'); ?> transition-colors">
                    <div class="mt-0.5 flex-shrink-0 grid h-8 w-8 place-items-center rounded-xl <?php echo e(!$n->read_at ? 'bg-indigo-600' : 'bg-slate-200'); ?>">
                        <svg class="h-4 w-4 <?php echo e(!$n->read_at ? 'text-white' : 'text-slate-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="flex items-start justify-between gap-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$n->read_at): ?>
                                <button wire:click="markRead(<?php echo e($n->id); ?>)" class="flex-shrink-0 text-[10px] text-indigo-500 hover:text-indigo-700 font-semibold whitespace-nowrap">
                                    Mark read
                                </button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div class="mt-1 flex items-center justify-between gap-2">
                            <span class="text-[10px] text-slate-400"><?php echo e($n->created_at?->diffForHumans()); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($n->link): ?>
                                <a href="<?php echo e($n->link); ?>" wire:click="markRead(<?php echo e($n->id); ?>)" x-on:click="open = false"
