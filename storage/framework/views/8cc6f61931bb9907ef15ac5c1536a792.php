...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'More Features','subtitle' => 'All modules and utilities grouped in one place.','accent' => 'more']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'More Features','subtitle' => 'All modules and utilities grouped in one place.','accent' => 'more']); ?>
...
<?php endif; ?>
	        ...
	        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
	            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($user?->role, $feature['roles'])): ?>
	                    <?php $scheme = $colors[$feature['color']]; ?>
	                    <?php
	                    ...
	                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAvailable): ?>
	                        <a href="<?php echo e(route($feature['route'])); ?>" class="<?php echo e($cardClass); ?>">
	                            <div class="flex items-start gap-4">
	                                <div class="icon-3d grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br <?php echo e($scheme['icon']); ?> text-white shadow-xl <?php echo e($scheme['shadow']); ?> transition-transform group-hover:scale-110 group-hover:rotate-6">
	                                    <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
	                                        <path d="<?php echo e($feature['icon']); ?>"/>
	                                    </svg>
	                                </div>
	                                <div class="flex-1 min-w-0">
	                                    <div class="text-lg font-black text-gray-900"><?php echo e($feature['title']); ?></div>
	                                    <div class="mt-1.5 text-sm font-semibold text-gray-600"><?php echo e($feature['desc']); ?></div>
	                                </div>
	                            </div>
	                        </a>
	                    <?php else: ?>
	                        <div class="<?php echo e($cardClass); ?>" aria-disabled="true">
	                            <div class="flex items-start gap-4">
	                                <div class="icon-3d grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br <?php echo e($scheme['icon']); ?> text-white shadow-xl <?php echo e($scheme['shadow']); ?>">
	                                    <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
	                                        <path d="<?php echo e($feature['icon']); ?>"/>
	                                    </svg>
	                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/pages/more-features/index.blade.php ENDPATH**/ ?>