<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div class="rounded-2xl bg-white p-6 shadow-lg">
            <div class="text-center">
                ...
                <p class="text-3xl font-bold text-green-600 mt-2"><?php echo e($stats['present']); ?></p>
            </div>
        </div>
        <div class="rounded-2xl bg-white p-6 shadow-lg">
            <div class="text-center">
                <p class="text-sm font-semibold text-gray-600">Absent</p>
                <p class="text-3xl font-bold text-red-600 mt-2"><?php echo e($stats['absent']); ?></p>
            </div>
        </div>
        <div class="rounded-2xl bg-white p-6 shadow-lg">
            <div class="text-center">
                <p class="text-sm font-semibold text-gray-600">Attendance Rate</p>
                <p class="text-3xl font-bold text-blue-600 mt-2"><?php echo e($stats['rate']); ?>%</p>
            </div>
        </div>
    </div>
    ...
    <div class="rounded-2xl bg-white p-6 shadow-lg">
        <div class="flex items-center justify-between mb-6">
            ...
            <h3 class="text-lg font-bold text-gray-900">
                <?php echo e(\Carbon\Carbon::create($selectedYear, $selectedMonth, 1)->format('F Y')); ?>
        ...
        <div class="grid grid-cols-7 gap-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center text-xs font-bold text-gray-600 py-2"><?php echo e($day); ?></div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                ...
                <div class="aspect-square p-1">
                    <div class="h-full rounded-lg flex flex-col items-center justify-center text-sm
                        <?php if($isToday): ?> ring-2 ring-blue-500 <?php endif; ?>
                        <?php if($mark): ?>
                            <?php if($mark->status === 'Present'): ?> bg-green-100 text-green-800
                            <?php elseif($mark->status === 'Absent'): ?> bg-red-100 text-red-800
                            <?php elseif($mark->status === 'Late'): ?> bg-yellow-100 text-yellow-800
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mark): ?>
                            <span class="text-xs mt-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mark->status === 'Present'): ?> ✓
                                <?php elseif($mark->status === 'Absent'): ?> ✗
                                <?php elseif($mark->status === 'Late'): ?> ⏰
    ...
    <!-- Recent Attendance -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attendanceRecords->isNotEmpty()): ?>
        <div class="rounded-2xl bg-white p-6 shadow-lg">
            <h3 class="text-lg font-bold text-gray-900 mb-4">This Month's Records</h3>
            <div class="space-y-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attendanceRecords->sortByDesc(fn($mark) => $mark->sheet->date); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center
                                <?php if($mark->status === 'Present'): ?> bg-green-100 text-green-600
                                <?php elseif($mark->status === 'Absent'): ?> bg-red-100 text-red-600
                                <?php elseif($mark->status === 'Late'): ?> bg-yellow-100 text-yellow-600
                                <?php endif; ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mark->status === 'Present'): ?>
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-900"><?php echo e($mark->sheet->date->format('l, F d, Y')); ?></p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mark->note): ?>
                                    <p class="text-xs text-gray-600"><?php echo e($mark->note); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                        <span class="text-sm font-semibold
                            <?php if($mark->status === 'Present'): ?> text-green-600
                            <?php elseif($mark->status === 'Absent'): ?> text-red-600
                            <?php elseif($mark->status === 'Late'): ?> text-yellow-600
                            <?php endif; ?>">
