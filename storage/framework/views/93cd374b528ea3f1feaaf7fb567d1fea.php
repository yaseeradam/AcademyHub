    ...
    <div class="relative overflow-hidden rounded-2xl shadow-xl" style="background-color: #1a2e4a;">
        ...
        <div class="relative flex items-end justify-between">
            ...
            <div class="hidden lg:block flex-shrink-0 self-end">
                <img src="<?php echo e(asset('uploads/admin avatar.png')); ?>" alt="Admin Avatar"
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-400 to-amber-500 p-6 text-white shadow-lg">
            ...
            <div class="relative flex items-start justify-between">
                <div>
                    <div class="text-4xl font-black"><?php echo e(number_format($studentsTotal)); ?></div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 p-6 text-white shadow-lg">
            ...
            <div class="relative flex items-start justify-between">
                <div>
                    <div class="text-4xl font-black"><?php echo e(number_format($teachersTotal)); ?></div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-400 to-teal-500 p-6 text-white shadow-lg">
            ...
            <div class="relative flex items-start justify-between">
                <div>
                    <div class="text-4xl font-black"><?php echo e(number_format(\App\Models\SchoolClass::count())); ?></div>
    ...
    <div class="grid grid-cols-1 gap-5 lg:grid-cols-3 items-start">
        ...
        <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-100 flex flex-col justify-center">
            <div class="mb-3 flex items-center justify-between">
                ...
                <div class="text-xs text-slate-400"><?php echo e($studentsTotal); ?> total</div>
            </div>
            <div class="flex justify-center">
                <div class="relative h-36 w-36">
                    <canvas id="genderDonutChart"></canvas>
                    <div class="absolute inset-0 flex flex-col items-center justify-center">
                        <div class="text-2xl font-black text-slate-800"><?php echo e($studentsTotal > 0 ? round(($studentsGirls / $studentsTotal) * 100) : 0); ?>%</div>
            ...
            <div class="mt-3 flex justify-center gap-4 text-xs">
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="text-slate-600">Male <?php echo e($studentsTotal > 0 ? round(($studentsBoys / $studentsTotal) * 100) : 0); ?>%</span>
                </div>
                <div class="flex items-center gap-1.5">
                    <span class="h-2.5 w-2.5 rounded-full bg-violet-500"></span>
                    <span class="text-slate-600">Female <?php echo e($studentsTotal > 0 ? round(($studentsGirls / $studentsTotal) * 100) : 0); ?>%</span>
                </div>
            </div>
            <div class="mt-1 text-center text-xs text-slate-400">Out of <?php echo e($studentsTotal); ?></div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-5 lg:grid-cols-3 items-start">
        ...
        <div class="lg:col-span-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
            <div class="mb-4 flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Board 1','Board 2','Board 3','Board 4','Board 5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="rounded-full px-2 py-0.5 text-xs font-semibold"
                            style="background:<?php echo e(['#fb923c','#a78bfa','#34d399','#60a5fa','#f472b6'][$i]); ?>22;color:<?php echo e(['#ea580c','#7c3aed','#059669','#2563eb','#db2777'][$i]); ?>">
                            <?php echo e($b); ?>
            ...
            <div class="space-y-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-sm font-bold text-orange-500"><?php echo e(round($row->avg_score)); ?>%</div>
                    </div>
...
<script>
    window.dashboardData = {
        ...
        boys: <?php echo e($studentsBoys); ?>,
        girls: <?php echo e($studentsGirls); ?>,
