...
<div id="app" class="min-h-screen">
    ...
    <aside id="mobileSidebar" class="fixed inset-y-0 left-0 z-50 w-72 transform -translate-x-full transition-transform duration-300 lg:hidden">
        <div class="flex h-full flex-col bg-white shadow-xl">
            ...
            <div class="px-4 py-4 border-b border-gray-100 bg-green-50">
                ...
                <div class="text-xs text-green-700 font-semibold"><?php echo e(session('student_admission')); ?></div>
                <div class="text-xs text-gray-500 mt-0.5"><?php echo e(session('student_class')); ?></div>
            </div>
    ...
    <aside id="desktopSidebar" class="fixed inset-y-0 left-0 hidden w-64 flex-col bg-white shadow-xl transition-all duration-300 lg:flex">
        ...
        <div class="sidebar-text px-4 py-3 border-b border-slate-100 bg-green-50">
            <div class="text-xs font-bold text-gray-900 truncate"><?php echo e(session('student_name')); ?></div>
            <div class="text-xs text-green-700 font-semibold"><?php echo e(session('student_admission')); ?></div>
            <div class="text-xs text-gray-400 truncate"><?php echo e(session('student_class')); ?></div>
        </div>
        ...
        <header class="sticky top-0 z-10 border-b border-slate-100 bg-white/80 backdrop-blur-xl shadow-md">
            ...
            <div class="flex h-16 items-center justify-between px-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    ?>
                    <a href="<?php echo e(route('student.notifications')); ?>" class="relative rounded-xl p-2.5 text-gray-500 hover:bg-white hover:shadow-md transition-all">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($unreadCount ?? 0) > 0): ?>
                            <span class="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs font-black text-white"><?php echo e(($unreadCount ?? 0) > 9 ? '9+' : ($unreadCount ?? 0)); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </a>
