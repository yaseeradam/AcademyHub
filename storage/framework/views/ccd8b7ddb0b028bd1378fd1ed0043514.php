...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500"><?php echo e($student->full_name); ?> &bull; <?php echo e($student->schoolClass?->name); ?></p>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($published && $scores->isNotEmpty()): ?>
            <a href="<?php echo e(route('student.report-card', ['term' => $selectedTerm, 'session' => $selectedSession])); ?>"
               target="_blank"
            ...
            <div>
                ...
                <select wire:model.live="selectedSession"
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <option value="<?php echo e($selectedSession); ?>"><?php echo e($selectedSession); ?></option>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
            </div>
            <div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $published): ?>
        <div class="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-white py-16 text-center shadow-sm">
            ...
            <p class="mt-1 max-w-sm text-sm text-gray-500">
                Results for <strong><?php echo e($termLabel[$selectedTerm] ?? 'Term '.$selectedTerm); ?></strong> &bull; <strong><?php echo e($selectedSession); ?></strong> have not been released yet. Check back later.
            </p>
        </div>
    ...
    <?php else: ?>
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 to-purple-700 p-5 text-white shadow-lg">
                ...
                <div class="mt-2 text-4xl font-extrabold"><?php echo e($average); ?></div>
                <div class="text-sm font-semibold text-violet-200">out of <?php echo e($maxTotal); ?></div>
                <div class="mt-1 text-xs text-violet-300"><?php echo e($avgPct); ?>%</div>
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 p-5 text-white shadow-lg">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($overallPosition): ?>
                    <div class="mt-2 text-4xl font-extrabold"><?php echo e($ordinal($overallPosition)); ?></div>
                    <div class="text-sm font-semibold text-amber-100">out of <?php echo e($classSize); ?></div>
                <?php else: ?>
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 p-5 text-white shadow-lg">
                ...
                <div class="mt-2 text-4xl font-extrabold"><?php echo e($passed); ?></div>
                <div class="text-sm font-semibold text-emerald-100">of <?php echo e($totalSubjects); ?> subjects</div>
                <div class="pointer-events-none absolute -right-4 -top-4 h-20 w-20 rounded-full bg-white/10"></div>
            </div>
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-500 to-red-600 p-5 text-white shadow-lg">
                ...
                <div class="mt-2 text-4xl font-extrabold"><?php echo e($failed); ?></div>
                <div class="text-sm font-semibold text-rose-100">subject<?php echo e($failed !== 1 ? 's' : ''); ?></div>
                <div class="pointer-events-none absolute -right-4 -top-4 h-20 w-20 rounded-full bg-white/10"></div>
            </div>
        </div>
                ...
                <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-100 transition hover:shadow-md">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div class="flex items-center gap-3 min-w-0">
                            <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl <?php echo e($gc['bg']); ?>">
                                <span class="text-sm font-extrabold <?php echo e($gc['text']); ?>"><?php echo e($score->grade); ?></span>
                            </div>
                            <div class="min-w-0">
                                <div class="truncate text-sm font-bold text-gray-900"><?php echo e($score->subject?->name); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($gc['label']); ?></div>
                            </div>
                        </div>

                        
                        <div class="flex items-center gap-2 text-xs font-semibold">
                            <span class="rounded-lg bg-blue-50 px-2.5 py-1 text-blue-700">CA1: <?php echo e($score->ca1 ?? '—'); ?></span>
                            <span class="rounded-lg bg-indigo-50 px-2.5 py-1 text-indigo-700">CA2: <?php echo e($score->ca2 ?? '—'); ?></span>
                            <span class="rounded-lg bg-purple-50 px-2.5 py-1 text-purple-700">Exam: <?php echo e($score->exam ?? '—'); ?></span>
                        </div>

                        
                        <div class="text-right flex-shrink-0">
                            <div class="text-xl font-extrabold text-gray-900"><?php echo e($score->total); ?><span class="text-sm font-semibold text-gray-400">/<?php echo e($maxTotal); ?></span></div>
                            <div class="text-xs font-semibold text-gray-500"><?php echo e($pct); ?>%</div>
                        </div>
                    </div>

                    
                    <div class="mt-3 h-2 w-full overflow-hidden rounded-full bg-gray-100">
                        <div class="h-full rounded-full <?php echo e($gc['bar']); ?> transition-all duration-700"
        ...
        <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100 overflow-hidden">
            <div class="border-b border-gray-100 px-6 py-4">
                <h2 class="text-sm font-bold text-gray-700 uppercase tracking-wider">Score Sheet — <?php echo e($termLabel[$selectedTerm] ?? 'Term '.$selectedTerm); ?> &bull; <?php echo e($selectedSession); ?></h2>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $scores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $score): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $gc = $gradeConfig[$score->grade] ?? $gradeConfig['F']; ?>
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-5 py-3.5 font-semibold text-gray-900"><?php echo e($score->subject?->name); ?></td>
                                <td class="px-4 py-3.5 text-center text-gray-700"><?php echo e($score->ca1 ?? '—'); ?></td>
                                <td class="px-4 py-3.5 text-center text-gray-700"><?php echo e($score->ca2 ?? '—'); ?></td>
                                <td class="px-4 py-3.5 text-center text-gray-700"><?php echo e($score->exam ?? '—'); ?></td>
                                <td class="px-4 py-3.5 text-center font-bold text-gray-900"><?php echo e($score->total); ?></td>
                                <td class="px-4 py-3.5 text-center">
                                    <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-bold <?php echo e($gc['bg']); ?> <?php echo e($gc['text']); ?>">
                                        <?php echo e($score->grade); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3.5 text-center text-gray-600">
                                    <?php echo e($score->position ? $ordinal($score->position) : '—'); ?>
                    ...
                    <tfoot>
                        <tr class="bg-gray-50 font-bold text-gray-800">
                            ...
                            <td class="px-4 py-3.5 text-center"><?php echo e($scores->sum('ca1')); ?></td>
                            <td class="px-4 py-3.5 text-center"><?php echo e($scores->sum('ca2')); ?></td>
                            <td class="px-4 py-3.5 text-center"><?php echo e($scores->sum('exam')); ?></td>
                            <td class="px-4 py-3.5 text-center"><?php echo e($scores->sum('total')); ?></td>
                            <td colspan="2" class="px-4 py-3.5 text-center text-violet-700">
                                Avg: <?php echo e($average); ?> (<?php echo e($avgPct); ?>%)
                            </td>
                        </tr>
                    </tfoot>
                </table>
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gradeCounts->isNotEmpty()): ?>
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
                <h3 class="mb-4 text-sm font-bold uppercase tracking-wider text-gray-500">Grade Distribution</h3>
                <div class="flex flex-wrap gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $gradeConfig; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g => $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gradeCounts->has($g)): ?>
                            <div class="flex items-center gap-2 rounded-xl <?php echo e($cfg['bg']); ?> px-4 py-2.5">
                                <span class="text-lg font-extrabold <?php echo e($cfg['text']); ?>"><?php echo e($g); ?></span>
                                <div>
                                    <div class="text-xs font-bold <?php echo e($cfg['text']); ?>"><?php echo e($gradeCounts[$g]); ?> subject<?php echo e($gradeCounts[$g] > 1 ? 's' : ''); ?></div>
                                    <div class="text-xs <?php echo e($cfg['text']); ?> opacity-75"><?php echo e($cfg['label']); ?></div>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
