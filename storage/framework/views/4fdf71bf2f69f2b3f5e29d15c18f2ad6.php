...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['sortable' => false, 'selectable' => false, 'items' => []]));
...
foreach (array_filter((['sortable' => false, 'selectable' => false, 'items' => []]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="enhancedTable(<?php echo e($sortable ? 'true' : 'false'); ?>, <?php echo e($selectable ? 'true' : 'false'); ?>)"
    class="overflow-hidden rounded-2xl bg-white shadow-soft ring-1 ring-gray-100">
    <!-- Table Header with Search -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortable || $selectable): ?>
    ...
    <div class="overflow-x-auto">
        <table <?php echo e($attributes->merge(['class' => 'w-full text-left border-collapse'])); ?>>
            <?php echo e($slot); ?>
...
</script><?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/components/table.blade.php ENDPATH**/ ?>