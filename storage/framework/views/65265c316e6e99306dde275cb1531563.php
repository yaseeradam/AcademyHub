...
?>
    ...
    <div class="page">
        ...
        <div class="session-ribbon">
            Academic Session <?php echo e($session); ?> • Term <?php echo e($term); ?> • Issued <?php echo e(now()->format('F d, Y')); ?>
        ...
        <div class="next-royal">♔ Next Term Begins: <?php echo e($nextTermDate ?? 'To be announced'); ?> ♔</div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="footer"><?php echo e($schoolName); ?> • Excellence in Education</div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\myacademy-laravel\resources\views/pdf/report-card-royal.blade.php ENDPATH**/ ?>