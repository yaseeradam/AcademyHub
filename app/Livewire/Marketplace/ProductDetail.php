    ...
    private function getProductData(string $product): array
    {
        $products = [
            'whatsapp-bot' => [
                ...
                'description' => 'The AcademyHub WhatsApp Bot is a comprehensive automated messaging system that allows parents to receive real-time notifications about their children\'s school activities and interact with the school through WhatsApp.',
                'icon' => 'whatsapp',
                'color' => 'green',
            ...
            'student-dashboard' => [
                ...
                'requirements' => ['AcademyHub system', 'Student admission number', 'Web browser', 'Internet connection'],
            ...
            'cbt' => [
                ...
                'requirements' => ['AcademyHub system', 'Web browser', 'Stable internet connection', 'Computer lab (recommended)'],
            ...
            'savings-loan' => [
                ...
                'requirements' => ['AcademyHub system', 'Admin access', 'Staff records', 'Payroll integration'],
            ...
            'messages' => [
                ...
                'description' => 'A built-in messaging system that lets admins, teachers, and bursars communicate directly within AcademyHub.',
                'icon' => 'messages',
                'color' => 'amber',
                'category' => 'Communication',
                ...
                'requirements' => ['AcademyHub system', 'Admin, Teacher, or Bursar account', 'Web browser'],
            ...
            'homework' => [
                ...
                'requirements' => ['AcademyHub system', 'Active Student & Teacher accounts'],
            ...
            'e-learning' => [
                ...
                'description' => 'The AcademyHub E-Learning module allows teachers to upload digital learning resources, class notes, and course materials, allowing students to access and study course content online.',
                'icon' => 'document',
                'color' => 'cyan',
                'category' => 'Education',
                ...
                'requirements' => ['AcademyHub system', 'Web browser', 'Internet connection'],
            ...
            'parent-portal' => [
                ...
                'description' => 'The AcademyHub Parent Portal is a dedicated space for parents to log in securely and check their children\'s real-time progress, attendance logs, exam scores, and unpaid/paid financial bills.',
                'icon' => 'student',
                'color' => 'blue',
                'category' => 'Portal',
            ...
            'payment-gateway' => [
                ...
                'requirements' => ['AcademyHub system', 'Bursar access', 'Paystack active credentials (optional)'],
