...
class StudentSession
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // Check if student is using the default password — force them to change it
        if (session('student_must_reset_password') === true && !$request->is('student/profile', 'student/logout', 'livewire*')) {
