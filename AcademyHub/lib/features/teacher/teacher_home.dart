        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            if (_loading)
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _statCard('Students', '$_totalStudents', Icons.people, const Color(0xFF10B981), onTap: () => context.push('/students')),
            ...
            Row(
              ...
              children: [
                ...
                TextButton.icon(
                  ...
                  icon: const Icon(Icons.campaign, size: 20, color: Color(0xFF3B82F6)),
                  label: const Text('Publish News', style: TextStyle(color: Color(0xFF3B82F6), fontWeight: FontWeight.bold)),
                ),
              ],
            ),
            const SizedBox(height: 16),
            ...
            GridView.count(
              ...
              childAspectRatio: 1.2,
              children: [
                _actionCard('Take Attendance', Icons.how_to_reg, const Color(0xFF10B981), () => context.push('/attendance')),
                _actionCard('Enter Scores', Icons.edit_note, const Color(0xFF3B82F6), () => context.push('/scores')),
