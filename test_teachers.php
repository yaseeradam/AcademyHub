...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Import Teachers','subtitle' => 'CSV columns: name, email (optional: password, is_active).','accent' => 'teachers']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Import Teachers','subtitle' => 'CSV columns: name, email (optional: password, is_active).','accent' => 'teachers']); ?>
