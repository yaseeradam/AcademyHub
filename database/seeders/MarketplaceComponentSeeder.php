    ...
    public function run(): void
    {
        $components = [
            ...
            [
                'name' => 'Aptitude Test',
                'slug' => 'aptitude-test',
                'route_name' => 'aptitude.index',
                'price' => 12000.00,
                'pricing_model' => 'flat',
                'setup_fee' => 5000.00,
                'usage_fee_per_student' => 0.00,
                'short_description' => 'Test and grade new applicants before admission',
                'description' => 'Allows schools to register new applicants, create custom multiple-choice admission screening tests per class, automatically grade answers, and seamlessly admit passing applicants into active classes.',
                'category' => 'Examination',
                'icon' => 'exam',
                'is_active' => true,
                'rating_avg' => 4.80,
            ...
            [
                ...
                'route_name' => 'payment-gateway.index',
                'price' => 20000.00,
                'pricing_model' => 'flat',
                'setup_fee' => 10000.00,
                'usage_fee_per_student' => 0.00,
                'short_description' => 'Configure online payments for parents and track school transactions',
                'description' => 'Equips your Bursar department with secure online credit card gateways (Paystack/QuickPay) for parents to pay student fees. Set up dynamic fee scales for each school class, verify payment status, and track incoming real-time financial statements.',
                'category' => 'Finance',
                'icon' => 'finance',
                'is_active' => true,
                'rating_avg' => 4.85,
