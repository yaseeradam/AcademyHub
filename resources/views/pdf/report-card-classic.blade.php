...
@endphp
    ...
    <div class="page">
        <div class="page-inner">
            ...
            {{-- TOP ROW: Header + Meta + Student Info + Summary --}}
            <div class="rc-top">
                <div class="header">
            ...
            {{-- MID ROW: Scores Table + Grading Key + Attendance --}}
            <div class="rc-mid">
            ...
            {{-- BOT ROW: Psychomotor + Remarks + School Fees + Next Term + Signatures + Footer --}}
            <div class="rc-bot">
