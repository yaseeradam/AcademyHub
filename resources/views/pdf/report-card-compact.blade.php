...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page { border: 3px double #0284c7; padding: 8px; background: #fff; display: table; width: 100%; height: 100%; min-height: 100%; }
        .page-inner { border: 1px solid #bae6fd; padding: 6px; display: table; width: 100%; height: 100%; min-height: 100%; }
        ...
        /* Table */
        table.scores { width: 100%; height: 100%; border-collapse: collapse; margin-bottom: 4px; border: 1px solid #bae6fd; }
        table.scores th { background: #0284c7; color: #fff; padding: 2px 3px; font-size: 7px; font-weight: 800; text-transform: uppercase; text-align: center; border: 1px solid #0284c7; }
        ...
        /* Grading Key */
        .grading { display: table; width: 100%; border: 1px solid #bae6fd; margin-bottom: 4px; border-radius: 4px; overflow: hidden; }
        ...
        /* Attendance */
        .att { display: table; width: 100%; margin-bottom: 4px; border: 1px solid #bae6fd; border-radius: 4px; overflow: hidden; }
        ...
        /* Remarks */
        .remarks { border: 1px solid #bae6fd; border-radius: 4px; padding: 3px 5px; margin-bottom: 3px; background: #f0f9ff; }
        .remarks-label { font-size: 7.5px; font-weight: 850; color: #0369a1; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 1px; }
        .remarks-text { font-size: 8px; color: #334155; min-height: 10px; line-height: 1.3; }

        /* Next Term */
        .next-term { background: linear-gradient(90deg, #0284c7 0%, #0369a1 100%); color: #fff; text-align: center; padding: 5px; font-size: 8.5px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px; border-radius: 4px; }
        ...
        .sig-line { border-top: 1.5px solid #0284c7; margin-top: 10px; padding-top: 2px; font-size: 8px; font-weight: 800; color: #0369a1; }
