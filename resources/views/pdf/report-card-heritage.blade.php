...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page { border: 5px double #a16207; padding: 10px; background: #fff; display: table; width: 100%; height: 100%; min-height: 100%; }
        .page-inner { border: 1.5px solid #1e3a8a; padding: 6px; display: table; width: 100%; height: 100%; min-height: 100%; }
        ...
        .header { border-bottom: 3px double #a16207; padding-bottom: 4px; margin-bottom: 6px; }
        ...
        /* Stats Panel */
        .stats { display: table; width: 100%; margin-bottom: 6px; border-collapse: separate; border-spacing: 2px; }
        ...
        /* Score Table */
        table.scores { width: 100%; height: 100%; border-collapse: collapse; margin-bottom: 6px; border: 1.5px solid #a16207; }
        table.scores th { background: #1e3a8a; color: #fff; padding: 3px 4px; font-size: 8px; font-weight: bold; text-transform: uppercase; text-align: center; border: 1px solid #a16207; letter-spacing: 0.5px; }
        table.scores td { padding: 2.5px 4px; border: 1px solid #a16207; text-align: center; font-size: 8.5px; color: #0f172a; }
        ...
        /* Grading Key */
        .grading { display: table; width: 100%; border: 1.5px solid #a16207; margin-bottom: 6px; overflow: hidden; }
        ...
        /* Attendance */
        .att { display: table; width: 100%; margin-bottom: 6px; border: 1.5px solid #1e3a8a; overflow: hidden; }
        ...
        .remarks-label { font-size: 8px; font-weight: bold; color: #1e3a8a; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 2px; }
        .remarks-text { font-size: 8.5px; color: #334155; min-height: 10px; line-height: 1.3; font-style: italic; }

        /* Next Term */
        .next-term { background: #1e3a8a; border: 1.5px solid #a16207; color: #fef08a; text-align: center; padding: 6px; font-size: 8.5px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 6px; }
        ...
        .sig-line { border-top: 1.5px solid #1e3a8a; margin-top: 10px; padding-top: 3px; font-size: 8.5px; font-weight: bold; color: #1e3a8a; }
