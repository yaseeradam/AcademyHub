...
<div class="page">
    <div class="page-inner">
        ...
        {{-- QR Code --}}
        @if($showQrCode)
        <div style="margin-top:4px;border-top:1px dashed #a16207;padding-top:4px;text-align:center;">
            @if(!empty($qrCodeUri))
                <img src="{{ $qrCodeUri }}" style="width: 42px; height: 42px; display: block; margin: 0 auto 2px auto;" alt="QR" />
            @endif
            <div style="font-size:7px;color:#78716c;">&#128274; <strong>Official Verified Record</strong> &bull; Ref: <strong>{{ $student->admission_number }}</strong></div>
        </div>
        @endif
