...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page { border: 4px solid #991b1b; padding: 10px; background: #fff; display: table; width: 100%; height: 100%; min-height: 100%; }
        .page-inner { border: 1.5px solid #d97706; padding: 6px; display: table; width: 100%; height: 100%; min-height: 100%; }
        ...
        .header { border-bottom: 2.5px solid #991b1b; padding-bottom: 4px; margin-bottom: 6px; text-align: center; }
        ...
        /* Scores Table */
        table.scores { width: 100%; height: 100%; border-collapse: collapse; margin-bottom: 6px; border: 1.5px solid #991b1b; }
        table.scores th { background: #7f1d1d; color: #fffbeb; padding: 3px 4px; font-size: 8px; font-weight: bold; text-transform: uppercase; text-align: center; border: 1px solid #d97706; }
        table.scores td { padding: 2.5px 4px; border: 1px solid #d97706; text-align: center; font-size: 9px; color: #450a0a; }
        ...
        /* Grading Key */
        .grading { display: table; width: 100%; border: 1.5px solid #991b1b; margin-bottom: 6px; border-radius: 4px; overflow: hidden; }
        ...
        /* Attendance */
        .att { display: table; width: 100%; margin-bottom: 6px; border: 1.5px solid #991b1b; border-radius: 4px; overflow: hidden; }
        ...
        /* Remarks */
        .remarks { border: 1.5px solid #991b1b; border-radius: 4px; padding: 3px 5px; margin-bottom: 3px; background: #fffbeb; }
        .remarks-label { font-size: 8px; font-weight: bold; color: #7f1d1d; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 2px; }
        .remarks-text { font-size: 8.5px; color: #450a0a; min-height: 10px; line-height: 1.3; font-style: italic; }

        /* Next Term Banner */
        .next-term { background: linear-gradient(90deg, #7f1d1d 0%, #991b1b 100%); border: 1.5px solid #d97706; color: #fffbeb; text-align: center; padding: 6px; font-size: 8.5px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 6px; border-radius: 4px; }
        ...
        .sig-line { border-top: 1.5px solid #7f1d1d; margin-top: 10px; padding-top: 3px; font-size: 8.5px; font-weight: bold; color: #7f1d1d; }
