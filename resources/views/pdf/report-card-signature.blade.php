...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Remarks */
        .remarks { border: 1.5px solid #991b1b; border-radius: 3px; padding: 5px 8px; margin-bottom: 5px; background: #fffbeb; }
        ...
        .remarks-text { font-size: 8px; color: #450a0a; line-height: 1.3; font-style: italic; }
...
<div class="page">
    <div class="page-inner">
        ...
        <div style="border:1.5px solid #991b1b;border-radius:3px;background:#fffbeb;padding:5px 8px;margin-bottom:5px;">
            <div style="font-size:7.5px;font-weight:bold;text-transform:uppercase;color:#7f1d1d;margin-bottom:3px;">Annual Cumulative Summary ({{ $session }})</div>
            <table style="width:100%;border-collapse:collapse;text-align:center;font-size:8px;">
                <thead><tr style="border-bottom:1px solid #fecaca;color:#7f1d1d;"><th style="padding:2px;">Term 1</th><th style="padding:2px;">Term 2</th><th style="padding:2px;">Term 3</th><th style="padding:2px;">Cumulative Avg</th></tr></thead>
                <tbody><tr>
