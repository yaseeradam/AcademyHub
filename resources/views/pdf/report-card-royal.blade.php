...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: DejaVu Serif, Georgia, serif; font-size: 9px; color: #1e1b4b; background: white; }

        /* ─── ROYAL Ornate Premium Style ─── */
        .page { border: 6px double #7c3aed; padding: 4px; background: white; position: relative; }
        .page-inner { border: 1.5px solid #d97706; padding: 18px; background: linear-gradient(135deg, #faf5ff 0%, #ffffff 50%, #faf5ff 100%); }

        .ornament-top { text-align: center; font-size: 20px; color: #d97706; margin-bottom: 8px; }
        
        .header { text-align: center; border-bottom: 2px solid #7c3aed; padding-bottom: 12px; margin-bottom: 12px; }
        .header-table { display: table; width: 100%; }
        .header-cell { display: table-cell; vertical-align: middle; }
        .logo-wrap { width: 75px; text-align: center; }
        .logo { width: 62px; height: 62px; object-fit: contain; border: 2px solid #d97706; border-radius: 8px; padding: 4px; background: white; }
        .school-name { font-size: 19px; font-weight: 900; color: #5b21b6; text-transform: uppercase; letter-spacing: 3px; margin-bottom: 2px; }
        .school-motto { font-size: 8.5px; color: #d97706; font-style: italic; font-weight: 700; margin-bottom: 2px; }
        .school-meta { font-size: 8px; color: #475569; margin-bottom: 1px; }
        .badge { display: inline-block; background: linear-gradient(135deg, #7c3aed, #5b21b6); color: #fbbf24; padding: 5px 20px; border-radius: 4px; font-size: 9px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; border: 1px solid #d97706; margin-top: 6px; }
        .meta-right { font-size: 8px; color: #5b21b6; font-weight: 750; text-align: right; }

        /* Stats Block */
        .stats { display: table; width: 100%; margin-bottom: 12px; }
        .stat { display: table-cell; padding: 2px; }
        .stat-inner { background: linear-gradient(135deg, #7c3aed, #5b21b6); border: 2px solid #d97706; border-radius: 8px; text-align: center; padding: 8px 4px; }
        .stat-label { font-size: 6.5px; color: #fbbf24; font-weight: 700; text-transform: uppercase; margin-bottom: 2px; }
        .stat-value { font-size: 14px; font-weight: 900; color: white; }

        /* Table */
        table.scores { width: 100%; border-collapse: collapse; margin-bottom: 12px; border: 2px solid #7c3aed; }
        table.scores th { background: linear-gradient(135deg, #5b21b6, #4c1d95); color: #fbbf24; padding: 6px 4px; font-size: 7.5px; font-weight: 800; text-transform: uppercase; border: 1px solid #7c3aed; }
        table.scores td { padding: 5px 4px; border: 1px solid #e9d5ff; text-align: center; font-size: 8.5px; color: #1e1b4b; }
        table.scores tr:nth-child(even) td { background: #faf5ff; }
        .subj { text-align: left !important; font-weight: 700; color: #5b21b6; padding-left: 8px !important; font-style: italic; }
        .bold { font-weight: 800; color: #4c1d95; }

        /* Grading Key */
        .grading { display: table; width: 100%; border: 2px solid #e9d5ff; margin-bottom: 12px; border-radius: 6px; overflow: hidden; background: white; }
        .gr-cell { display: table-cell; padding: 5px 4px; text-align: center; font-size: 7.5px; font-weight: 700; color: #5b21b6; border-right: 1px solid #e9d5ff; }
        .gr-cell:last-child { border-right: none; }
        .gr-cell strong { color: #d97706; font-size: 9px; }

        /* Attendance */
        .att { display: table; width: 100%; margin-bottom: 12px; border: 2px solid #e9d5ff; border-radius: 6px; overflow: hidden; background: white; }
        .att-cell { display: table-cell; width: 33.33%; text-align: center; padding: 6px; border-right: 1px solid #e9d5ff; }
        .att-cell:last-child { border-right: none; }
        .att-label { font-size: 7.5px; font-weight: 800; text-transform: uppercase; color: #5b21b6; margin-bottom: 2px; }
        .att-value { font-size: 14px; font-weight: 900; color: #1e1b4b; }

        /* Remarks */
        .remarks { border: 2px solid #7c3aed; border-radius: 8px; padding: 8px 10px; margin-bottom: 8px; background: white; }
        .remarks-label { font-size: 7.5px; font-weight: 900; color: #5b21b6; text-transform: uppercase; font-style: italic; margin-bottom: 3px; }
        .remarks-text { font-size: 8px; color: #374151; min-height: 20px; line-height: 1.3; }

        /* Next Term */
        .next-term { background: linear-gradient(135deg, #7c3aed, #d97706); color: white; text-align: center; padding: 6px; font-size: 9px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; border-radius: 6px; border: 1.5px solid #fbbf24; }
        ...
        .sig-line { border-top: 2px solid #7c3aed; margin-top: 24px; padding-top: 3px; font-size: 8.5px; font-weight: 800; color: #5b21b6; font-style: italic; }
        .sig-line.has-img { margin-top: 3px; }
        .sig-sub { font-size: 6.5px; color: #7c3aed; font-style: italic; margin-top: 1px; opacity: 0.8; }

        .ornament-bottom { text-align: center; font-size: 18px; color: #d97706; margin-top: 6px; }
        .footer { text-align: center; font-size: 7px; color: #9ca3af; margin-top: 6px; font-style: italic; }
...
<div class="page">
    <div class="page-inner">
        ...
        {{-- Student Info --}}
        @php($siBorderColor = '#7c3aed') @php($siBgColor = '#faf5ff') @php($siLabelColor = '#5b21b6') @php($siValueColor = '#1e1b4b') @php($siDotColor = '#c4b5fd')
