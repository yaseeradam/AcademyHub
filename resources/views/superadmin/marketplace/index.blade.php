                        ...
                        <td style="text-align:right;">
                            <div class="sa-dropdown" x-data="{ open: false }" @click.outside="open = false">
                                ...
                                <div x-show="open" 
                                     ...
                                     style="display: none; right: 0; min-width: 155px;">
                                    <a href="{{ route('superadmin.marketplace.edit', $component) }}" class="sa-dropdown-item">
                                    ...
                                    <form action="{{ route('superadmin.marketplace.destroy', $component) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this component?');" style="margin: 0; width: 100%;">
                                        @csrf
                                        @method('DELETE')
