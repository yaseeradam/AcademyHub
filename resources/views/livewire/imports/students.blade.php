<div class="space-y-6">
    ...
    >
        ...
        <div class="flex flex-wrap items-center gap-2">
            <button type="button" wire:click="analyze" class="btn-outline" :disabled="!$wire.file || uploading">
                Analyze
            </button>
            ...
            <button
                ...
                :disabled="!$wire.file || uploading || $wire.aiAnalyzing"
            ...
            >
                <svg x-show="$wire.aiAnalyzing" class="h-4 w-4 animate-spin" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"/>
                </svg>
                <svg x-show="!$wire.aiAnalyzing" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                </svg>
                <span x-text="$wire.aiAnalyzing ? 'Analyzing…' : 'Analyze with AI'"></span>
            </button>

            <button type="button" wire:click="import" class="btn-primary" :disabled="!$wire.file || uploading">
                Import
            </button>
        </div>
