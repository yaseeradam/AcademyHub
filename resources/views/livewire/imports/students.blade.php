    ...
    >
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            >
                ...
                <img wire:loading.remove wire:target="analyzeWithAI" src="{{ asset('ai.png') }}" class="h-5 w-5 object-contain" alt="AI" />
                    ...
                    @if ($aiRows)
                        <div>
                            <div class="flex items-center justify-between mb-3">
                                ...
                                >
                                    <img src="{{ asset('ai.png') }}" class="h-3.5 w-3.5 object-contain" alt="AI" />
                                    Chat with AI
                                </button>
                            </div>
