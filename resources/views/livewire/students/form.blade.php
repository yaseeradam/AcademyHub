            ...
            <div class="space-y-4">
                ...
                <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <div class="text-sm font-semibold text-gray-900">Student Portal Password</div>
                    </div>
                    <p class="text-xs text-gray-500 mb-4">
                        @if($student)
                            Leave blank to keep the current password unchanged.
                        @else
                            Required. The student logs in with their <strong>admission number</strong> and this password.
                        @endif
                    </p>
                    ...
                    <div class="space-y-3">
                        <div>
                            <label class="text-xs font-semibold text-gray-600 uppercase tracking-wide">
                                ...
                                @if(!$student)<span class="text-red-500">*</span>@endif
                            </label>
                            <div class="relative mt-1.5" x-data="{ show: false }">
                                <input
                                    wire:model="student_password"
                                    :type="show ? 'text' : 'password'"
                                    placeholder="{{ $student ? 'Leave blank to keep current' : 'Enter password (min 6 chars)' }}"
                                    class="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 pr-10 text-sm text-gray-700 shadow-sm focus:border-brand-500 focus:ring-brand-500"
                                />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="mt-1.5 w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 shadow-sm focus:border-brand-500 focus:ring-brand-500"
                            />
