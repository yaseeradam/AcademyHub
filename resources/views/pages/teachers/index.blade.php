                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                @if($teacher->is_class_teacher)
                                    <div class="mt-2">
                                        <span class="inline-flex items-center rounded-lg bg-gradient-to-r {{ $color['icon'] }} px-2.5 py-1 text-xs font-bold text-white shadow-sm">
                        ...
                        <div class="mt-6">
                            ...
                            @else
                                <div class="flex flex-wrap gap-2">
                                    @foreach ($rows->take(4) as $alloc)
                                        <span class="inline-flex items-center rounded-xl {{ $color['badge'] }} px-3 py-1.5 text-xs font-bold">
